...
async function getDependencies() {
  let dependencies = '@koa/cors koa koa-bodyparser koa-helmet koa-json koa-logger koa-router koa-swagger-decorator reflect-metadata';
  let devDependencies = '@types/koa @types/koa-bodyparser @types/koa-helmet @types/koa-json @types/koa-logger @types/koa-router @types/koa__cors @types/node ts-node tsc tslint typescript';
